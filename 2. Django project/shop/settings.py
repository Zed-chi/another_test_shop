...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "products.context_processors.root_categories",
            ],
        },
    },
]
...
DUMP_PAY_GATE_URL = env.str("DUMP_PAY_GATE_URL")
DUMP_PAY_GATE_TOKEN = env.str("DUMP_PAY_GATE_TOKEN")
